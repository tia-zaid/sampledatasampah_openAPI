document.addEventListener('DOMContentLoaded', function() {
    ...
    function getTasksForDate(day, dayOfWeek, weekOfMonth, isLastWeek) {
        ...
        // TUGAS SPESIFIK MINGGUAN & BULANAN
        switch (weekOfMonth) {
            case 1: // MINGGU 1
                ...
                if (dayOfWeek === 4) tasks.push({ text: "Edit 'Plastic Adventure of the Month' & 1 simple video", type: "editing" });
                if (dayOfWeek === 5) tasks.push({ text: "Shoot Interview Komunitas #1", type: "shooting" });
                break;
            case 2: // MINGGU 2
                if (dayOfWeek === 3) tasks.push({ text: "Shoot 'Before & After' #2", type: "shooting" });
                if (dayOfWeek === 4) tasks.push({ text: "Edit 2-3 requested simple videos", type: "editing" });
                if (dayOfWeek === 5) {
